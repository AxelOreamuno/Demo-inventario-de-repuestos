...
export default function ProviderMovements() {
  ...
  // Primero filtrar
  const filteredMovements = providerMovements.filter((movement) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 bg-gray-200 min-h-screen py-8">
      <h1 className="text-2xl font-bold mb-4 text-cyan-950">Movimientos de Proveedores</h1>
